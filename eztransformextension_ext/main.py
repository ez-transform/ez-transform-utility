"""EzTransformExtension cli entrypoint."""
...
def initialize(
    ...
    """Initialize the EzTransformExtension plugin."""
    try:
...
def main(
    ...
    """Simple Meltano extension that wraps the ezt CLI."""
